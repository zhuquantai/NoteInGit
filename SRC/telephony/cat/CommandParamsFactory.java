...
import android.text.TextUtils;//20160423-yangning.hong-add-for-D1924078-orange-stk-req
            ...
            if(def == 2) {
                if (cmdDet.typeOfCommand == AppInterface.CommandType.SET_UP_MENU.value()) {
                    if (menu.title != null && menu.title.length() <= SystemProperties.PROP_VALUE_MAX) {
                        /*begin-20160423-yangning.hong-modify-for-D1924078-orange-stk-req*/
                        ...
                        if(TextUtils.isEmpty(operatorList)){
                            ...
                            if(mCaller != null){
                               if(mCaller.getSlotId() == 0){
                                  SystemProperties.set("gsm.stk.perso.app_title_1", menu.title);
                               }else if(mCaller.getSlotId() == 1){
                                  SystemProperties.set("gsm.stk.perso.app_title_2", menu.title);
                               }
                            }
                        }
                        /*end-20160423-yangning.hong-modify-for-D1924078-orange-stk-req*/
                    }
                }
            }
