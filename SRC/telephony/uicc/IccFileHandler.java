...
public abstract class IccFileHandler extends Handler implements IccConstants {
    ...
    static class LoadLinearFixedContext {
        ...
        LoadLinearFixedContext(int efid, int recordNum, Message onLoaded) {
            ...
            mLoadAll = false;
            mPath = null;
	      mMode = -1;//zhibin.zhong add for Defect:1000509
        }
    ...
    public void loadEFImgLinearFixed(int recordNum, Message onLoaded) {
        Message response = obtainMessage(EVENT_GET_RECORD_SIZE_IMG_DONE,
                new LoadLinearFixedContext(IccConstants.EF_IMG, recordNum,
                        onLoaded));
        /*begin-20151209-yangning.hong-modify-response-size-for-D1019451*/
        ...
        /*end-20151209-yangning.hong-modify-response-size-for-D1019451*/
    }
