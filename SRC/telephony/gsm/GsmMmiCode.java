...
/*-begin-20160227-zubin.chen-add-for-df1660042-*/
import android.telephony.SubscriptionManager;
import android.telephony.TelephonyManager;
import com.android.internal.telephony.PhoneConstants;
/*-end-20160227-zubin.chen-add-for-df1660042-*/
...
*/
    ...
    //begin minguo.wan add 2015.10.19
    private static boolean isNormalCall(String dialString, GSMPhone phone) {
        if(dialString == null || phone == null) {
            Rlog.d(LOG_TAG, "isNormalCall:dialString or phone null,return false");
            return false;
        }
        /*-begin-20160227-zubin.chen-add-for-df1660042-*/
        TelephonyManager mTelephonyManager;
        boolean mIsSim1Inserted;
        boolean mIsSim2Inserted;            
        mTelephonyManager = TelephonyManager.getDefault();
        if (mTelephonyManager != null) {
            mIsSim1Inserted = mTelephonyManager.hasIccCard(PhoneConstants.SIM_ID_1);
            mIsSim2Inserted = mTelephonyManager.hasIccCard(PhoneConstants.SIM_ID_2);
	        //begin minguo.wan modify 2016.2.24 for defect1660042
	        if (dialString.equals("08") && (!phone.isInCall())) {
	            Rlog.d(LOG_TAG, "isNormalCall:treat number 08 as normal call");
	            if((mIsSim1Inserted && !mIsSim2Inserted)
	        		//&& SubscriptionManager.getSlotId(SubscriptionManager.getDefaultVoiceSubId()) == 0
	        		&& dialString != null
	        		&& dialString.equalsIgnoreCase("08")){//1.With an Orange SIM Card inserted in Slot 1 and Without SIM card in slot 2:dial 08,send emergency call
	            		return true;
	            }
	        }
	        if (dialString.equals("08") && (!phone.isInCall())) {
	            ...
	            if((!mIsSim1Inserted && !mIsSim2Inserted)
	        			&& dialString != null
	        			&& dialString.equalsIgnoreCase("08")){//3.Without SIM Card in Slot 1,Without SIM card in Slot 2:dial 08, device send a emergency call
	            	return true;
	            }
	        }  
        }
        //end minguo.wan modify 2016.2.24 for defect1660042
        /*-end-20160227-zubin.chen-add-for-df1660042-*/
        //begin minguo.wan modify 2015.10.19 for task 730293 isdm:def_9_asdialcode_enable
        if (dialString.equals("#9") && (!phone.isInCall()) 
                && Boolean.parseBoolean(
                        phone.getContext().getResources().getString
                        (com.android.internal.R.string.def_9_asdialcode_enable))) {
            Rlog.d(LOG_TAG, "isNormalCall:def_9_asdialcode_enable = true");
            return true;
        }
       //end minguo.wan modify 2015.10.19 for task 730293 isdm:def_9_asdialcode_enable

        //begin minguo.wan add for task841233 merge from D340521 on 20151103
        //for GTS2.1_r2 testTestTelephonyCall_bindsToInCallServiceAndAddsCall failed
        if (dialString.equals("7") || (dialString.startsWith("3") && dialString.length() == 2)) {
            Rlog.d(LOG_TAG, "newFromDialString: dialString is 7 or 3x");
			//begin minguo.wan modify 2015.11.03 for task841233 merge from defect 711060
            if(!phone.isInCall()){
                Rlog.d(LOG_TAG, "newFromDialString: dial string not in call");
                return true;
            }
			//end minguo.wan modify 2015.11.03 for task841233 merge from defect 711060
        }
        //end minguo.wan add for task841233 merge from D340521 on 20151103

        //begin minguo.wan modify 2015.10.19 for task742132 isdm:def_telephony_StarSharpZero_on
        if ((dialString.equals("*0")||dialString.equals("#0")) && (!phone.isInCall())
                && Boolean.parseBoolean(
                 phone.getContext().getResources().getString
                     (com.android.internal.R.string.def_telephony_StarSharpZero_on))) {
            Rlog.d(LOG_TAG, "isNormalCall:def_telephony_StarSharpZero_on = true");
            return true;
         }
        //end minguo.wan modify 2015.10.19 for task742132 isdm:def_telephony_StarSharpZero_on

        //begin minguo.wan modify 2015.10.19 for task 730492 isdm:def_two_digits_asdialcode_enable
        if ((dialString.equals("92") || dialString.equals("93") ||  dialString.equals("94"))
                && (!phone.isInCall())
                &&Boolean.parseBoolean(
                        phone.getContext().getResources().getString
                        (com.android.internal.R.string.def_two_digits_asdialcode_enable))) {
            Rlog.d(LOG_TAG, "isNormalCall:def_two_digits_asdialcode_enable = true");
            return true;
         }
        //end minguo.wan modify 2015.10.19 for task 730492，742132 isdm:def_two_digits_asdialcode_enable

        //begin minguo.wan modify 2015.10.19 for task 730388 isdm def_ro_com_Guatemala_SP_call
        if ((dialString.length() == 2) && (dialString.charAt(0) == '*'
                && dialString.charAt(1) >= '0' && dialString.charAt(1) <= '9')
                && (!phone.isInCall()) && Boolean.parseBoolean(
                        phone.getContext().getResources().getString
                        (com.android.internal.R.string.def_ro_com_Guatemala_SP_call))) {
            Rlog.d(LOG_TAG, "isNormalCall:def_ro_com_Guatemala_SP_call = true");
            return true;
        }
        //end minguo.wan modify 2015.10.19 for task 730388，742132 isdm def_ro_com_Guatemala_SP_call

        //begin minguo.wan modify 2015.10.19 for task 730293，742132 isdm:def_phone_treat_pound_number_as_call
        if (((dialString.length() == 2) && (dialString.charAt(0) == '#'
                && dialString.charAt(1) >= '0' && dialString.charAt(1) <= '9'))
                && (!phone.isInCall())
                && Boolean.parseBoolean(phone.getContext().getResources().getString
                        (com.android.internal.R.string.def_phone_treat_pound_number_as_call))) {
            Rlog.d(LOG_TAG, "isNormalCall:def_phone_treat_pound_number_as_call = true");
            return true;
        }
        //begin minguo.wan modify 2015.10.19 for task 730293，742132 isdm:def_phone_treat_pound_number_as_call
        Rlog.d(LOG_TAG, "isNormalCall:ussd call,return false");
        return false;
    }
    //end minguo.wan add 2015.10.19
    /**
    ...
    newFromDialString(String dialString, GSMPhone phone, UiccCardApplication app) {
        Matcher m;
        GsmMmiCode ret = null;
        //begin minguo.wan add 2015.10.19 for task
        if (isNormalCall(dialString,phone)){
            return ret;
        }
        //end minguo.wan add 2015.10.19
        // add by zhibin.zhong for RR 595861 begin
        if (dialString != null && phone != null && dialString.equals("#9")&& !phone.isInCall()&& Boolean.parseBoolean(
                phone.getContext().getResources().getString(com.android.internal.R.string.def_9_asdialcode_enable))) {
             Rlog.d(LOG_TAG, "newFromDialString:def_9_asdialcode_enable =true");
            return ret;
        }
        // add by zhibin.zhong for RR 595861 end
...
*/
    ...
    static private boolean isShortCode(String dialString, GSMPhone phone) {
        ...
        if (mTelephonyManager != null) {
	    	...
	    	if((mIsSim1Inserted && mIsSim2Inserted)
	    			&& dialString != null
	    			&& dialString.equalsIgnoreCase("08")){//2.With an Orange SIM Card inserted in Slot 1 and With SIM card in slot 2:dial 08, device send a ussd
	    		return isShortCodeUSSD(dialString, phone);
	    	}else if((mIsSim1Inserted && !mIsSim2Inserted)
	    			//&& SubscriptionManager.getSlotId(SubscriptionManager.getDefaultVoiceSubId()) == 0
	    			&& dialString != null
	    			&& dialString.equalsIgnoreCase("08")){//1.With an Orange SIM Card inserted in Slot 1 and Without SIM card in slot 2:dial 08,send emergency call   
	    		return false;
            ...
            if (isShortCode()) {
                ...
                if (isActivate()) {
                    if (mPhone.isOpTbClir()) {
                        //begin gchenli merge the MTK patch ALPS02660885 for D1899043
                        mPhone.mCi.setCLIR(CommandsInterface.CLIR_INVOCATION,
                            obtainMessage(EVENT_SET_COMPLETE, this));
                        //end gchenli merge the MTK patch ALPS02660885 for D1899043
                        return;
                    }
                    ...
                    if (mPhone.isOpTbClir()) {
                        ...
                        mPhone.mCi.setCLIR(CommandsInterface.CLIR_SUPPRESSION,
                            obtainMessage(EVENT_SET_COMPLETE, this));
                        //end gchenli merge the MTK patch ALPS02660885 for D1899043                        //end gchenli merge the MTK patch ALPS02660885 for D1899043
                        return;
                    }
    ...
    onUssdFinishedError() {
        if (mState == State.PENDING) {
            mState = State.FAILED;
            //begin minguo.wan modify 2015.10.24 for task 742152 730526 isdm:feature_telephony_ussdUnrequestInfo_on
            if(mContext.getResources().getBoolean(com.android.internal.R.bool.feature_telephony_ussdUnrequestInfo_on)) {
                Rlog.d(LOG_TAG, "onUssdFinishedError():feature_telephony_ussdUnrequestInfo_on=0x01");
                mMessage = mContext.getText(com.android.internal.R.string.mmi_unrequest);
            } else {
                Rlog.d(LOG_TAG, "onUssdFinishedError():feature_telephony_ussdUnrequestInfo_on=0x00");
                mMessage = mContext.getText(com.android.internal.R.string.mmiError);
            }
            //end minguo.wan modify 2015.10.24 for task 742152 730526 isdm:feature_telephony_ussdUnrequestInfo_on
            mPhone.onMMIDone(this);
        }
    }
    ...
    onUssdRelease() {
        if (mState == State.PENDING) {
            mState = State.COMPLETE;
            /* begin modify by gchenli for defect1158934 display "MMI complete" message */
            //mMessage = null;
            if(mContext != null){
                mMessage = mContext.getText(com.android.internal.R.string.mmiComplete);
            } else {
            ...
            Rlog.d(LOG_TAG, "onUssdRelease mMessage:" + mMessage);
            /* end modify by gchenli for defect1158934 display "MMI complete" message */
        ...
        switch (msg.what) {
            ...
            case EVENT_SET_CFF_COMPLETE:
                ...
                */
                ...
                /*old: if ((ar.exception == null) && (msg.arg1 == 1)) {
                ...
                if (isShowCFIForBusyNoanswerNotavailable) {
                    if (ar.exception == null) {
                        ...
                        } else if (reason == CF_REASON_BUSY) {
                            GSMPhone.CF_STATE_BUSY = cffEnabled ? true : false;
                        } else if (reason == CF_REASON_NO_REPLY) {
                            GSMPhone.CF_STATE_NO_REPLY = cffEnabled ? true : false;
                        } else if (reason == CF_REASON_NOT_REACHABLE) {
                            GSMPhone.CF_STATE_NOT_REACHABLE = cffEnabled ? true: false;
                        } else if (reason == CF_REASON_ALL) {
                            GSMPhone.CF_STATE_UNCONDITIONAL = cffEnabled ? true: false;
                            GSMPhone.CF_STATE_BUSY = cffEnabled ? true : false;
                            GSMPhone.CF_STATE_NO_REPLY = cffEnabled ? true : false;
                            GSMPhone.CF_STATE_NOT_REACHABLE = cffEnabled ? true: false;
                        } else if (reason == CF_REASON_ALL_CONDITIONAL) {
                            GSMPhone.CF_STATE_BUSY = cffEnabled ? true : false;
                            GSMPhone.CF_STATE_NO_REPLY = cffEnabled ? true : false;
                            GSMPhone.CF_STATE_NOT_REACHABLE = cffEnabled ? true: false;
                        }
                        ...
                        Rlog.i(LOG_TAG,"setVoiceCallForwardingFlag aborted. sim records is null.");
                    }
                } else {
                ...
                //EDN modify by minguo.wan for TASK 730571 2015-11-16
                onSetComplete(msg, ar);
                break;
    ...
    makeCFQueryResultMessage(CallForwardInfo info, int serviceClassMask) {
        ...
        //begin minguo.wan add 20151117 merge from defect427480 [Language][G05][Arabic][MMI String]The "+"place error in *#21# after setup forwarding number in Arabic
        if(destinations[1] != null){
            // "\u202D"&"\u202C" means the strings which between them will always show from left to right
            destinations[1] = "\u202D" + destinations[1] + "\u202C";
        }
        //end minguo.wan add 20151117 merge from defect427480 [Language][G05][Arabic][MMI String]The "+"place error in *#21# after setup forwarding number in Arabic
        /* M: SS part end */
