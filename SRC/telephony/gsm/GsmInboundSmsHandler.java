...
public class GsmInboundSmsHandler extends InboundSmsHandler {
    ...
    protected void onUpdatePhoneObject(PhoneBase phone) {
        ...
        mCellBroadcastHandler.dispose();
        //add by weiwen.huang.hz 20160205 alm1177030 begin
        try{
            //modify by weiwen.huang.hz 20160222 alm1177030 begin
            final Object lockObject = new Object();
            synchronized (lockObject) {
                lockObject.wait(500);
            }
            //modify by weiwen.huang.hz 20160222 alm1177030 end
        }catch(InterruptedException e){
            log("GsmInboundSmsHandler good wait() interrupted");
        }
        catch(Exception e){
            log("GsmInboundSmsHandler Unexpected exception wait():"+e);
        }
        //add by weiwen.huang.hz 20160205 alm1177030 end
