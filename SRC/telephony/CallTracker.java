...
public abstract class CallTracker extends Handler {
    ...
    */
    ...
    protected Connection getHoConnection(DriverCall dc) {
        ...
        //old:log("SRVCC: getHoConnection() with dc, number = " + dc.number + " state = " + dc.state);
        if (Build.IS_USER_BUILD){
            log("SRVCC: getHoConnection() with dc, number = " + "*******" + " state = " + dc.state);
        }else{
    ...
    protected String checkForTestEmergencyNumber(String dialString) {
        ...
        if (DBG_POLL) {
            ...
            */
            if (Build.IS_USER_BUILD){
                log("checkForTestEmergencyNumber: dialString=" + "*******" +
                        " testEn=" + testEn);
            }else{
                log("checkForTestEmergencyNumber: dialString=" + dialString +
                        " testEn=" + testEn);
