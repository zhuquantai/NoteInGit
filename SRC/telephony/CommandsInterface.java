...
//  static final int CF_ACTION_UNUSED           = 2;
    ...
    */
    ...
    void setCDMACardInitalEsnMeid(Handler h, int what, Object obj);
    void unSetCDMACardInitalEsnMeid(Handler h);
    // MTK-END, SMS part
  ...
  /**
    ...
    void registerForSuspendedSetStatus(Handler h, int what, Object obj);
    void unregisterForSuspendedSetStatus(Handler h);
    /// @}
