...
public final class ImsPhoneCallTracker extends CallTracker {
    ...
    protected void log(String msg) {
        //begin gchenli merge the MTK patch ALPS02660885 for D1899043
        /// M: add phone id to log @{
        // Rlog.d(LOG_TAG, "[ImsPhoneCallTracker] " + msg);
        Rlog.d(LOG_TAG, "[ImsPhoneCallTracker][Phone" + mPhone.getPhoneId() + "] " + msg);
        /// @}
        //end gchenli merge the MTK patch ALPS02660885 for D1899043
    }
    ...
    protected void loge(String msg) {
        ...
        Rlog.e(LOG_TAG, "[ImsPhoneCallTracker][Phone" + mPhone.getPhoneId() + "] " + msg);
        /// @}
        //end gchenli merge the MTK patch ALPS02660885 for D1899043
    }
