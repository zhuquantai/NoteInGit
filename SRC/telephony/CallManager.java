    ...
    */
    ...
    private void registerForPhoneStates(Phone phone, Phone phoneMmi) {
        ...
        if (phoneMmi instanceof SvltePhoneProxy
            ...
            phoneMmi.registerForMmiInitiate(handler, EVENT_MMI_INITIATE, mRegistrantidentifier);
            phoneMmi.registerForMmiComplete(handler, EVENT_MMI_COMPLETE, mRegistrantidentifier);
        } else {
            phone.registerForMmiInitiate(handler, EVENT_MMI_INITIATE, mRegistrantidentifier);
            phone.registerForMmiComplete(handler, EVENT_MMI_COMPLETE, mRegistrantidentifier);
        }
        /* M: Bug Fix end */
