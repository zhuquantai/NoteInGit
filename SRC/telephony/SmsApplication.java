...
/*begin-20151021-huawei.wang-add for task743383*/
import com.android.internal.R;
/*end-20151021-huawei.wang-add for task743383*/
...
public final class SmsApplication {
    ...
    private static Collection<SmsApplicationData> getApplicationCollectionInternal(
		...
		/*begin-20151021-huawei.wang-add for task743383*/
            	if( context.getResources().getBoolean(R.bool.def_hide_smartsuit_clarosync_as_defaultsms) &&
		           ("com.tcl.smartsuite".equals(packageName)  || "br.com.amxsync".equals(packageName) || "br.com.claroespanhol".equals(packageName))) {
                		continue;
                	}
		/*end-20151021-huawei.wang-add for task743383*/
