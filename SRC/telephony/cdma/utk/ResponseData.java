...
class LocalInformationResponseData extends ResponseData {
    ...
    switch(mLocalInfoType) {
        ...
        {
            UtkLog.d(this, "LocalInformationResponseData format DateTime " + "Year:" +
                        mDate.getYear() + "Month:" + mDate.getMonth() + "Day:" + mDate.getDate());
            UtkLog.d(this, "Hour:" + mDate.getHours() + "Minutes:" + mDate.getMinutes() +
            ...
            UtkLog.d(this, "TimeZone:" + "rawzone:" + defaultZone.getRawOffset() +
                                                        "tempzone" + tempzone + "zone" + zone);
