...
public class BipService {
    ...
    private static final int BIPCHANNEL_MAX = 8;

    private static final Uri APN_URI = Telephony.Carriers.CONTENT_URI;
    private static final String APN_DEFFAULT = "ctwap";
    private static final String APN_USER_NAME = "ctwap@mycdma.cn";
    private static final String APN_PASSWORD = "vnet.mobi";
    private static final String APN_ENABLE_FEATURE = Phone.FEATURE_ENABLE_SUPL;
    private static final int DEFAULT_NETWORK_TYPE = ConnectivityManager.TYPE_MOBILE;
    ...
    private BipChannel CreatNewBipChannel(OpenChannelSettings p) {
        ...
        if (p.transportLevel.protocolType ==
            ...
            ch = new TcpClientChannel(this, p, id, mContext);
            /* API is removed on M0
            ...
            ch = new UdpClientChannel(this, p, id, mContext);
            /*API is removed on M0
            mConnectivityManager.requestRouteToHostAddress(
                    DEFAULT_NETWORK_TYPE, p.destAddress.address);
             */
            ...
            ch = new TcpServerChannel(this, p, id, mContext);
        } else {
