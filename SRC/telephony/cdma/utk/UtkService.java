...
public class UtkService extends Handler implements AppInterface, IUtkService {
    ...
    private static IccRecords sIccRecordsSim1;
    private static UiccCardApplication sUiccApplicationSim1;
    private static IccRecords sIccRecordsSim2;
    private static UiccCardApplication sUiccApplicationSim2;
    ...
    private static final boolean LTE_UTK_DBG = true;
    private static int sMutliSimType = -1;
    ...
    public static boolean sQueryMenuFlag = false;
    ...
    static final int UTK_TIMER_MAX = 8;
    ...
    private final BroadcastReceiver mIRStateChangeReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (SvlteRatController.INTENT_ACTION_FINISH_SWITCH_ROAMING_MODE.
    ...
    private UtkService(CommandsInterface ci, UiccCardApplication ca, IccRecords ir,
        ...
        if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()) {
            if (LTE_UTK_DBG) {
                sMutliSimType = getMutliSimType();
                UtkLog.d(LOG_TAG, " sMutliSimType " + sMutliSimType);
            }
        }
        ...
        if (PhoneConstants.SIM_ID_1 == mPhoneId) {
            sIccRecordsSim1 = ir;
            sUiccApplicationSim1 = ca;
            sUiccApplicationSim1.registerForReady(this, MSG_ID_RUIM_READY, null);
        } else {
            sIccRecordsSim2 = ir;
            sUiccApplicationSim2 = ca;
            sUiccApplicationSim2.registerForReady(this, MSG_ID_RUIM_READY, null);
        }
        //mUiccApplication = ca;
    ...
    public void dispose() {
        ...
        if ((PhoneConstants.SIM_ID_1 == mPhoneId) && (sUiccApplicationSim1 != null)) {
            sUiccApplicationSim1.unregisterForReady(this);
            sUiccApplicationSim1 = null;
        } else if ((PhoneConstants.SIM_ID_2 == mPhoneId) && (sUiccApplicationSim2 != null)) {
            sUiccApplicationSim2.unregisterForReady(this);
            sUiccApplicationSim2 = null;
        } else {
    ...
    private void updateIccStatus(int index) {
        ...
        if (PhoneConstants.SIM_ID_1 == index) {
            if (sUiccApplicationSim1 != newUiccApplication) {
                UtkLog.d(this, "mUiccApplicationSim1 have changed!");
                if (sUiccApplicationSim1 != null) {
                ...
                if (newUiccApplication != null) {
                    ...
                    sActiveUtkId = index;
                    sUiccApplicationSim1 = newUiccApplication;
                    sUiccApplicationSim1.registerForReady(this, MSG_ID_RUIM_READY, null);
                } else {
                    sActiveUtkId = -1;
                }
            ...
            if (sUiccApplicationSim2 != newUiccApplication) {
                UtkLog.d(this, "mUiccApplicationSim2 have changed!");
                if (sUiccApplicationSim2 != null) {
                ...
                if (newUiccApplication != null) {
                    ...
                    sActiveUtkId = index;
                    sUiccApplicationSim2 = newUiccApplication;
                    sUiccApplicationSim2.registerForReady(this, MSG_ID_RUIM_READY, null);
                } else {
                    sActiveUtkId = -1;
                }
    ...
    private void handleProactiveCommand(CommandParams cmdParams) {
        ...
        case REFRESH: {
            ...
            IccRecords mIccRecords = (mPhoneId == 0) ? sIccRecordsSim1 : sIccRecordsSim2;
    ...
    private void sendTerminalResponse(CommandDetails cmdDet,
        ...
        //Add for UTK IR case
        if ((CommandType.SET_UP_MENU.value() == cmdDet.typeOfCommand) && sQueryMenuFlag) {
            UtkLog.d(this, "Ignore response from query menu case");
            sQueryMenuFlag = false;
            return;
        }
        ByteArrayOutputStream buf = new ByteArrayOutputStream();
        ...
        if ((CdmaFeatureOptionUtils.isCdmaLteDcSupport()) &&
                (UTK_CARD_TYPE_UIM_AND_USIM == sMutliSimType)) {
            ...
            sRilDcArbitrator.sendTerminalResponse(hexString, null, cmdType, sMutliSimType);
        } else {
    ...
    private void sendMenuSelection(int menuId, boolean helpRequired) {
        ...
        if ((CdmaFeatureOptionUtils.isCdmaLteDcSupport()) &&
            ...
            UtkLog.d(this, "UTK LTE: sendMenuSelection through " +
                    "lte ril arbitrator, cmdType = " + cmdType);
            sRilDcArbitrator.sendEnvelope(hexString, null, cmdType, sMutliSimType);
        } else {
            mCmdIf.sendEnvelope(hexString, null);
        }
    ...
    public static UtkService getInstance(CommandsInterface ci,
        ...
        synchronized (sInstanceLock) {
            if ((PhoneConstants.SIM_ID_1 == tempPhoneId && sInstanceSim1 == null)
                ...
                if ((ca != null) && (sUiccApplicationSim1 != ca)) {
                    if (sUiccApplicationSim1 != null) {
                        sUiccApplicationSim1.unregisterForReady(sInstanceSim1);
                    }
                    sUiccApplicationSim1 = ca;
                    sUiccApplicationSim1.registerForReady(sInstanceSim1, MSG_ID_RUIM_READY, null);
                    UtkLog.d(sInstanceSim1, "sInstanceSim1 reinitialize with new ca");
                }
                if ((ir != null) && (sIccRecordsSim1 != ir)) {
                    sIccRecordsSim1 = ir;
                ...
                if ((ca != null) && (sUiccApplicationSim2 != ca)) {
                    if (sUiccApplicationSim2 != null) {
                        sUiccApplicationSim2.unregisterForReady(sInstanceSim2);
                    }
                    sUiccApplicationSim2 = ca;
                    sUiccApplicationSim2.registerForReady(sInstanceSim2, MSG_ID_RUIM_READY, null);
                    UtkLog.d(sInstanceSim2, "sInstanceSim2 reinitialize with new ca");
                }
                if ((ir != null) && (sIccRecordsSim2 != ir)) {
                    sIccRecordsSim2 = ir;
    ...
    public void handleMessage(Message msg) {
        ...
        case MSG_ID_MENU_INFO:
            ...
            if (MSG_ID_MENU_INFO == msg.what) {
                UtkLog.d(this, "menu data is " + data);
                if (TextUtils.isEmpty(data)) {
                    UtkLog.d(this, "MSG_ID_MENU_INFO, data is null");
                    break;
                }
            }
            if (mRilMsgDecoding) {
        ...
        case MSG_ID_CMD_LOCAL_INFO:
            ...
            if (msg.what == MSG_ID_CMD_LOCAL_INFO) {
                ...
                if (mCatchLocalInfoCmd != null) {
                    UtkLog.d(this, "response cmd local info: mCatchLocalInfoCmd != null! ");
                ...
                } else if ((mCurrntCmd != null) && ((CommandType.LOCAL_INFO.value() ==
                        mCurrntCmd.mCmdDet.typeOfCommand))) {
            ...
            case OPEN_CHANNEL:
                ...
                if (ResultCode.OK == resMsg.resCode) {
                    if (resMsg.usersConfirm) {
                        ...
                        if ((mCurrntCmd == null) ||
                                (mCurrntCmd.mCmdDet.typeOfCommand !=
                                        CommandType.OPEN_CHANNEL.value())) {
                                UtkLog.d(this, "mCurrntCmd is null , and use mCatchChannelCmd");
                                if (mCatchChannelCmd == null) {
                                    UtkLog.d(this, "mCurrntCmd is null , "
                                            + "and mCatchChannelCmd is null");
    ...
    /**
     * event download.
     * @param resMsg UtkResponseMessage.
     */
