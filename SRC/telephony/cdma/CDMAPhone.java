...
public class CDMAPhone extends PhoneBase {
        ...
        if (mSST == null) {
            ...
            switch (mDcTracker.getState(apnType)) {
                ...
                case DISCONNECTING:
                    ...
                    // TODO: Move to CDMALTEPhone, when apply it.
                    // M: check peer phone is in call for SRLTE
                    if (CdmaFeatureOptionUtils.isSrlteSupport()
                        ...
                        for (int i = 0; i < phoneCount; i++) {
                            ...
                            if (pb != null && i != getPhoneId() &&
                                ...
                                Rlog.d(LOG_TAG, "Phone" + i + " is in call," +
                                        " Data state set to SUSPENDED");
                                ret = PhoneConstants.DataState.SUSPENDED;
                            }
                        }
                    }
    ...
    public void queryPhbStorageInfo(int type, Message response) {
        ...
        if (fh != null) {
            ...
            Rlog.d(LOG_TAG, "queryPhbStorageInfo AsyncResult:" + ar);
            Rlog.d(LOG_TAG, "queryPhbStorageInfo ar.result:" + ar.result);
        }
