...
public class ApnContext {
    ...
    public void decRefCount(LocalLog log) {
        synchronized (mRefCountLock) {
            ...
            /// M: Add protection to prevent mRefCount < 0 in some situations.
            /// Ex, when pluged out a CDMA card, phone/DcTracker will be updated
            /// and decRefCount will be executed on the new object.
            if (mRefCount == 0) {
                log("decRefCount: (mRefCount == 0) unexpected.");
                return;
            }
