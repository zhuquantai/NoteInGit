...
public class PhoneProxy extends Handler implements Phone {
    ...
    public PhoneProxy(PhoneBase phone) {
        ...
        /*Change PhoneProxy's mIccCardProxy to SvlteIccCardProxy for send
          PIN to MD1 in SVLTE CT 4G card*/
        if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()) {
            mIccCardProxy = new SvlteIccCardProxy(mActivePhone.getContext(),
    ...
    public void getCallForwardingOptionForServiceClass(int commandInterfaceCFReason,
            int serviceClass,
            Message onComplete) {
        mActivePhone.getCallForwardingOptionForServiceClass(commandInterfaceCFReason,
                serviceClass,
                onComplete);
    }
    ...
    public void setCallForwardingOptionForServiceClass(int commandInterfaceCFReason,
            int commandInterfaceCFAction, String dialingNumber,
            int timerSeconds, int serviceClass, Message onComplete) {
        mActivePhone.setCallForwardingOptionForServiceClass(commandInterfaceCFReason,
            commandInterfaceCFAction,
            dialingNumber, timerSeconds, serviceClass, onComplete);
    }
    ...
    public void getFacilityLockForServiceClass(String facility, String password,
        ...
        mActivePhone.getFacilityLockForServiceClass(facility, password, serviceClass, onComplete);
    }
