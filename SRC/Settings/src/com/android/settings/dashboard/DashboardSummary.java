...
public class DashboardSummary extends InstrumentedFragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_REBUILD_UI: {
                    ...
                    // Handle rebuild message | add by quantai.zhu 9/29/16
                    rebuildUI(context);
                } break;
            }
        }
    ...
    public void onResume() {
        ...
        // RebuildUI | add by quantai.zhu 9/29/16
        sendRebuildUI();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Load Setting layout | add by quantai.zhu 9/29/16
    ...
    private void rebuildUI(Context context) {
        ...
        // Clear view | add by quantai.zhu 9/29/16
    ...
    private void sendRebuildUI() {
        if (!mHandler.hasMessages(MSG_REBUILD_UI)) {
            // Send rebuild message | add by quantai.zhu 9/29/16
