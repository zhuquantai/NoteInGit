...
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    // Override in Fragment | add by quantai.zhu 9/28/16
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // Lunch switch bar | add by quantai.zhu 9/28/16
    ...
    public void onDestroyView() {
        super.onDestroyView();
        // modify for test | add by quantai.zhu 9/29/16
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        // 通过BluetoothAdapter获取搜寻状态，从而改变Menu文字显示 | add by quantai.zhu 9/28/16
        ...
        switch (item.getItemId()) {
            case MENU_ID_SCAN:
                if (mLocalAdapter.getBluetoothState() == BluetoothAdapter.STATE_ON) {
                    ...
                    // 重新扫描 | add by quantai.zhu 9/28/16
                    startScanning();
                }
                return true;
            ...
            case MENU_ID_RENAME_DEVICE:
                ...
                // 显示一个DialogFragment | add by quantai.zhu 9/28/16
            ...
            case MENU_ID_SHOW_RECEIVED:
                ...
                // 发送广播打开文件接收位置 | add by quantai.zhu 9/28/16
    ...
    // Bluetooth Callback | add by quantai.zhu 9/28/16
    @Override
    ...
    // 实现Indexable接口 | add by quantai.zhu 9/28/16
