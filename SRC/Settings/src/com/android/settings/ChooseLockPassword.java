...
public class ChooseLockPassword extends SettingsActivity {
    ...
    /// M: voice unlock fallback password @ {
    public static Intent createIntent(Context context, int quality, final boolean isFallback,
        ...
        intent.putExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK, isFallback);
        intent.putExtra(EncryptionInterstitial.EXTRA_REQUIRE_PASSWORD, requirePasswordToDecrypt);
        return intent;
    }
    /// @ }
        ...
        public void handleNext() {
            ...
            if (mUiStage == Stage.Introduction) {
                ...
                if (mFirstPin.equals(pin)) {
                    ...
                    final String isFallbackFor = getActivity().getIntent().getStringExtra(
                             LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK_FOR);
                    if (commandKey != null) {
                            Settings.System.putString(getActivity().getContentResolver(),
                                    commandKey, commandValue);
                    }
                    mLockPatternUtils.clearLock(isFallback, UserHandle.myUserId());
